...
java -Xmx1g -jar /home/vicker/programs/Trimmomatic-0.32/trimmomatic-0.32.jar\
    ...
    ../dunwell_data/L006_R1_fixed.fq ../dunwell_data/L006_R2_fixed.fq\
    ../dunwell_data/L006_R1_trimmed.fq ../dunwell_data/L006_R1_ignore.fq ../dunwell_data/L006_R2_trimmed.fq ../dunwell_data/L006_R2_ignore.fq\

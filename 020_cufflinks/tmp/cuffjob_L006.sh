...
outdir='/home/vicker/vesca_annotation/cufflinks_mildew_L006'
${tophat} --no-coverage-search -o ${outdir} ${ref} ../dunwell_data/L006_R1_trimmed.fq ../dunwell_data/L006_R2_trimmed.fq

#strawberry
#ref='../refseq/fvesca_v1.1_scaffolds.fa'
#outdir='../cufflinks_vesca_L006'
# ${tophat} -o ${outdir} ${ref} ../dunwell_data/L006_R1_trimmed.fq ../dunwell_data/L006_R2_trimmed.fq
